...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'address-review', label: 'Address Review', icon: 'inbox', placeholder: false, visibility: ['platform_admin'] },
...
export const ADMIN_ONLY_NAV_IDS = new Set([
  'sources', 'db-stats', 'economics', 'admin-users', 'recent-jobs', 'sync', 'settings', 'dedup-queue', 'announcements', 'email-templates', 'contributions', 'zero-risk-admin', 'discovery-review', 'address-review',
]);
...
export const LOCAL_ENGINE_NAV_IDS = new Set([
  ...
  'manual-lookup', 'harvest-history', 'engine', 'discovery-review', 'address-review',
]);
...
const ICONS = {
  ...
  tender:    html`<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 13h6M9 17h4"/></svg>`,
  ...
  book:      html`<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5z"/><path d="M4 15.5A2.5 2.5 0 0 1 6.5 13H20"/></svg>`,
  ...
  bookmark:  html`<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3h12a1 1 0 0 1 1 1v17l-7-4-7 4V4a1 1 0 0 1 1-1z"/></svg>`,
