...
const LABEL_MAP = [
  ['Oil & Gas', ['oil', 'gas', 'petroleum', 'petrochemical', ' lng', 'hydrocarbon', 'upstream', 'downstream']],
  ['Energy & Utilities', ['electricity', 'power generation', 'utilities', 'water treatment', 'solar', 'renewable', 'district cooling', 'desalination']],
  ['Telecommunications', ['telecom', 'communication', 'broadband', 'fiber', 'fibre', 'satellite', 'network services']],
  ['Information Technology', ['information technology', 'software', ' it ', 'ict', 'computer', 'digital', 'technology', 'cyber', 'data services']],
  ...
  ['Construction & Contracting', ['construct', 'contract', 'building', 'civil works', 'infrastructure']],
  ['Engineering', ['engineering', 'electromechanical']],
  ['Pharmaceuticals', ['pharmaceutical']],
  ['Healthcare', ['health', 'medical', 'hospital', 'clinic', 'pharma', 'dental', 'nursing', 'diagnostic', 'wellness clinic']],
  ['Logistics & Transport', ['logistic', 'transport', 'shipping', 'freight', 'cargo', 'warehous', 'supply chain', 'courier', 'maritime', 'port ']],
  ['Trading & Distribution', ['trading', 'trade', 'distribut', 'import', 'export', 'wholesale', 'merchant']],
  ...
  ['Automotive', ['automotive', 'vehicle', 'motor', ' auto']],
  ...
  ['Hospitality & F&B', ['hospitality', 'restaurant', 'food', 'beverage', 'catering', 'hotel', 'cafe', 'bakery']],
  ['Travel & Tourism', ['travel', 'tourism', ' tour']],
  ['Legal Services', ['legal', ' law', 'advocate', 'attorney']],
  ['Consulting', ['consult', 'professional services', 'business services', 'advisory', 'management services']],
  ['Security Services', ['security', 'surveillance', 'guarding']],
  ['Facilities & Cleaning', ['facilit', 'cleaning', 'maintenance', 'landscap', 'pest control']],
  ['Education & Training', ['education', 'training', 'school', 'academ', 'institute', 'university', 'e-learning', 'teaching']],
  ...
  ['Furniture & Interior', ['furniture', 'interior', 'joinery', 'upholstery']],
  ['Textiles & Garments', ['textile', 'garment', 'apparel', 'tailor', 'clothing']],
  ['Beauty & Wellness', ['beauty', 'salon', ' spa', 'cosmetic', 'perfume']],
