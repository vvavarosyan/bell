...
app.use('/api/real-estate',...feature, realestateRouter);
app.use('/api/knowledge',  ...feature, knowledgeRouter);
app.use('/api/osm',        ...feature, osmRouter);
...
app.use('/api/chains',               ...localTools, chainsRouter);
