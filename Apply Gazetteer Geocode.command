#!/bin/bash
# Apply the gazetteer geocode — puts addresses written the HUMAN way on the map
...
# ⚠️ This WRITES map pins. It first PROVES the method against locations that
# already have known coordinates and refuses to write anything unless it agrees.
# Takes ~20 minutes for ~1,600 addresses (polite pace). RESUMABLE — close any
# time and re-run. It pushes to production itself.
#
# Double-click to run.
set -u
...
"$NODE_BIN" scripts/gazetteer_geocode.js --apply
echo
