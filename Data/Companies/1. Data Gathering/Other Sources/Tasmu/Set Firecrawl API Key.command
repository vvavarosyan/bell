#!/bin/bash
# Bell.qa — save your Firecrawl API key for the Tasmu scraper. Stored locally in
# firecrawl.key (next to this file) and NEVER uploaded anywhere.
set -e
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR"

echo "=========================================================="
echo "   Set Firecrawl API key (Tasmu)"
echo "=========================================================="
echo
