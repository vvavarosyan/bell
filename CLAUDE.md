...
- **Data‑gap audit + weekly email:** `Data Gap Audit.command` (read‑only) and a Sunday self‑report (`Send Data Check Email Now.command` to test). It already found 387 emails / 420 phones seen‑but‑not‑stored.
